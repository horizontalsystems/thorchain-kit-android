...
class BalanceManager(
    ...
    private val _runeBalanceFlow = MutableStateFlow(balancesFlow.value[Denom.RUNE] ?: BigInteger.ZERO)
    ...
    fun handleBalances(balances: List<DenomBalance>) {
        ...
        _runeBalanceFlow.update { _balancesFlow.value[Denom.RUNE] ?: BigInteger.ZERO }
    }
}
